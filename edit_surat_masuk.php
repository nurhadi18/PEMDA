<?php
    ...
    $data = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT * FROM surat_masuk WHERE id_surat_msk = '$id_surat_msk'"));
?>
<!DOCTYPE html>
<html lang="en">
<head>
              ...
              <form method="POST" action="">
                ...
                <div class="card-body">
                  ...
                  <div class="input-group-prepend">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="no_surat_msk" placeholder="No Surat Masuk" value="<?=$data['no_surat_msk']?>">
                  </div>
                    <div class="form-group">
                  ...
                  <div class="input-group-prepend">
                    ...
                    <input type="date" class="form-control" id="exampleInputEmail1" name="tanggal_terima" placeholder="Tanggal Terima" value="<?=$data['tanggal_terima']?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="input-group-prepend">
                    ...
                    <textarea class="form-control" id="exampleInputEmail1" name="alamat_pengirim" placeholder="Alamat Pengirim"><?=$data['alamat_pengirim']?></textarea>
                 </div>
                <!-- /.card-body -->

                <div class="card-footer">
                  <button type="submit" value="submit" name="edit" class="btn btn-danger"><i class="fas fa-download">   Update</i></button>
                </div>
              </form>
            </div>
        <!-- /.row -->
...
<?php
  if(isset($_POST['edit'])){
    ...
    $sql = mysqli_query($koneksi, "UPDATE surat_masuk SET no_surat_msk = '$no_surat_msk', jenis_surat = '$jenis_surat', tanggal_terima = '$tanggal_terima', pengirim = '$pengirim', perihal = '$perihal', alamat_pengirim = '$alamat_pengirim' WHERE id_surat_msk= $id_surat_msk");
