            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title"><a href="tambah_surat_keluar.php"><button class="btn btn-success"><i class="fas fa-folder-plus"> Tambah Surat Keluar</button></i></a></h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td><a href="<?= 'edit_surat_keluar.php?id_surat_klr=' . $row['id_surat_klr'] ?>"><button class="btn btn-warning"><i class="material-icons fas fa-edit"></i> Edit</button></a>

                            <a href="<?= 'hapus_surat_keluar.php?id_surat_klr=' . $row['id_surat_klr'] ?>" onclick="return confirm('Yakin Menghapus Data Ini?')"><button class="btn btn-danger"><i class="material-icons fas fa-trash-alt"></i> Delete</button></a>
                          </td>
                        </tr>
