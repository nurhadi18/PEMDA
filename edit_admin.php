        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="admin.php">Back</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <form method="POST" action="">
                <div class="card-body">
                  ...
                  <div class="input-group-prepend">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="nama" placeholder="Nama Admin" value="<?=$data['nama']?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="input-group-prepend">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="username" placeholder="Username" value="<?=$data['username']?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="input-group-prepend">
                    ...
                    <input type="password" class="form-control" id="exampleInputEmail1" name="password" placeholder="Password" value="<?=$data['password']?>">
                  </div>
                 </div>
                <!-- /.card-body -->

                <div class="card-footer">
                  <button type="submit" value="submit" name="edit" class="btn btn-primary"><i class="fas fa-download">   Update</i></button>
                </div>
              </form>
            </div>
        <!-- /.row -->
...
<?php
  if(isset($_POST['edit'])){
    ...
    $sql = mysqli_query($koneksi, "UPDATE admin SET nama = '$nama', username = '$username',  password = '$password' WHERE id = $id");
