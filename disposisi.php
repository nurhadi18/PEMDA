          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><a href="tambah_disposisi.php"><button class="btn btn-success"><i class="fas fa-folder-plus"> Tambah Disposisi</button></i></a></h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
...
JOIN surat_keluar s ON d.id_surat_klr = s.id_surat_klr");
      ...
      <tr>
       <td><?php echo $no; ?></td>  
        <td><?php echo $row['no_surat_klr']?></td>
        <td><?php echo $row['jenis_surat']?></td>
        <td><?php echo $row['perihal']?></td>
        <td><?php echo $row['tgl_terima']?></td>
        <td><?php echo $row['ket_disposisi']?></td>

     <td><a href="<?= 'edit_disposisi.php?id='.$row['id_disposisi'] ?>"><button class="btn btn-warning"><i class="material-icons fas fa-edit"></i> Edit</button></a> 

            <a href="<?= 'hapus_disposisi.php?id_disposisi='.$row['id_disposisi'] ?>" 
