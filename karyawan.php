    ...
    <section class="content">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                 <h3 class="card-title"><a href="tambah_karyawan.php"><button class="btn btn-success"><i class="fas fa-user-plus">   Tambah Karyawan</button></a></i></h3> 
              </div>
              <!-- /.card-header -->
              <div class="card-body">
      ...
      <tr>
       <td><?php echo $no; ?></td>  
        ...
        <td><a href="<?= 'edit_karyawan.php?id='.$row['id'] ?>"><button class="btn btn-warning"><i class="material-icons fas fa-edit"></i> Edit</button></a> 
