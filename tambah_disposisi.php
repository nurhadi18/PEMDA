...
<div class="content-wrapper">
  ...
  <section class="content">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-secondary">
            ...
            <form method="POST" action="">
              <div class="card-body">
                <tr>
                  <td>No Surat Keluar<span class="text-secondary">*</span></td>
                  <td>
                    <select name="surat_keluar" class="form-control" required>
                      <option value=""> -- Pilih -- </option>
                      <?php
                      $sql = mysqli_query($koneksi, "SELECT * FROM surat_keluar");
                      while ($data = mysqli_fetch_assoc($sql)) { ?>
                        <option value="<?= $data['id_surat_klr'] ?>">
                          <?= $data['no_surat_klr'] ?>
                        </option>
                      <?php } ?>
                    </select>
                ...
                <button type="submit" value="Cari" name="cari" class="btn btn-secondary btn-icon-split btn-sm">
    ...
    if (isset($_POST['cari'])) {
      ...
      $id_surat_klr = $_POST['surat_keluar'];
      $sql = mysqli_query($koneksi, "SELECT * FROM surat_keluar WHERE id_surat_klr = $id_surat_klr");
          ...
          <div class="card-body">
            <div class="table-responsive">
              <form action="" method="POST">
                <input type="hidden" name="idsk" value="<?= $id_surat_klr ?>">
                <table class="table">
                  <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" name="jenis_surat" placeholder="Perihal" value="<?=$data['jenis_surat']?>">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input type="date" class="form-control" id="exampleInputEmail1" name="tgl_terima" placeholder="Tanggal Terima">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" name="ket_disposisi" placeholder="Disposisi">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <textarea class="form-control" id="exampleInputEmail1" name="isi_disposisi" placeholder="Isi Disposisi"></textarea>

                    </div>
                  </div>
                  <!-- /.card-body -->
                  <div class="card-footer">
                    <button type="submit" value="submit" name="simpan" class="btn btn-secondary"><i class="fas fa-paper-plane"></i> Submit</button>
                  </div>
                </table>
              </form>
            </div>
...
if (isset($_POST['simpan'])) {
  ...
  $sql = mysqli_query($koneksi, "INSERT INTO disposisi VALUES('', '$idsk', '$tgl_terima', '$ket_disposisi', '$isi_disposisi') ");
  if ($sql) {
    echo "
    <script>
