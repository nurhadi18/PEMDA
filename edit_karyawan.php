        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="karyawan.php">Back</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <form method="POST" action="">
                <div class="card-body">
                  ...
                  <div class="input-group-prepend">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="nama" placeholder="Nama Karyawan" value="<?=$data['nama']?>">
                  </div>
                    <div class="form-group">
                  <label for="pass1">Jenis Kelamin<span class="text-danger">*</span></label><select class="form-control select2" id="example1" name="jk">
                  ...
                  <div class="input-group-prepend">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="no_hp" placeholder="No.Hp" value="<?=$data['no_hp']?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="input-group-prepend">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="jabatan" placeholder="Jabatan" value="<?=$data['jabatan']?>">
                  </div>
                 </div>
                <!-- /.card-body -->

                <div class="card-footer">
                  <button type="submit" value="submit" name="edit" class="btn btn-success"><i class="fas fa-download">   Update</i></button>
                </div>
              </form>
            </div>
        <!-- /.row -->
...
<?php
  if(isset($_POST['edit'])){
    ...
    $sql = mysqli_query($koneksi, "UPDATE karyawan SET nama = '$nama', jk = '$jk',  alamat = '$alamat', no_hp = '$no_hp', jabatan = '$jabatan' WHERE id = $id");
