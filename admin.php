  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="col-12">
            <div class="card">
               <div class="card-header">
                <h3 class="card-title"><a href="tambah_admin.php"><button class="btn btn-success"><i class="fas fa-user-plus"></i> Tambah Admin</button></a></h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
      ...
      <tr>
       ...
       <td><a href="<?= 'edit_admin.php?id='.$row['id'] ?>"><button class="btn btn-warning"><i class="material-icons fas fa-edit"></i> Edit</button></a> 
