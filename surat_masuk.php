...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="dist/img/a.png" alt="PemkabProb" height="120" width="240">
  </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><a href="tambah_surat_masuk.php"><button class="btn btn-success"><i class="fas fa-folder-plus"> Tambah Surat Masuk</button></i></a></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
      ...
      <tr>
       <td><?php echo $no; ?></td>  
        <td><?php echo $row['no_surat_msk']?></td>
        <td><?php echo $row['jenis_surat']?></td>
        <td><?php echo $row['tanggal_terima']?></td>
        <td><?php echo $row['pengirim']?></td>
        <td><?php echo $row['perihal']?></td>
        <td><?php echo $row['alamat_pengirim']?></td>
        <td><a href="<?= 'edit_surat_masuk.php?id_surat_msk='.$row['id_surat_msk'] ?>"><button class="btn btn-warning"><i class="material-icons fas fa-edit"></i> Edit</button></a>

            <a href="<?= 'hapus_surat_masuk.php?id_surat_msk='.$row['id_surat_msk'] ?>" 
              onclick="return confirm('Yakin Menghapus Data Ini?')"><button class="btn btn-danger"><i class="material-icons fas fa-trash-alt"></i> Delete</button></a>
            </td>
      </tr>
