              ...
              <form method="POST" action="">
                <div class="card-body">
                  ...
                  <div class="input-group-prepend">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="no_surat_klr" placeholder="No Surat Keluar">
                  </div>
                    <div class="form-group">
                  ...
                  <div class="input-group-prepend">
                    ...
                    <input type="date" class="form-control" id="exampleInputEmail1" name="tanggal_kirim" placeholder="Tanggal Kirim">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="input-group-prepend">
                    ...
                    <textarea class="form-control" id="exampleInputEmail1" name="alamat_penerima" placeholder="Alamat Penerima"></textarea>
                  </div>
                 </div>
                <!-- /.card-body -->

                <div class="card-footer">
                  <button type="submit" value="submit" name="simpan" class="btn btn-warning"><i class="fas fa-paper-plane"> Submit</button></i>
                </div>
              </form>
            </div>
        <!-- /.row -->
...
<?php
  if(isset($_POST['simpan'])){
    ...
    $sql = mysqli_query($koneksi, "INSERT INTO surat_keluar VALUES('','$no_surat_klr','$jenis_surat','$tanggal_kirim','$pengirim','$perihal','$alamat_penerima')");
