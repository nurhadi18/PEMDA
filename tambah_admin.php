              ...
              <form method="POST" action="">
                <div class="card-body">
                  ...
                  <div class="input-group-prepend">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="nama" placeholder="Nama Admin">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="input-group-prepend">
                    ...
                    <input type="text " class="form-control" id="exampleInputEmail1" name="username" placeholder="Username"></input>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="input-group-prepend">
                    ...
                    <input type="password" class="form-control" id="exampleInputEmail1" name="password" placeholder="Password"></input>
                  </div>
                 </div>
                <!-- /.card-body -->

                <div class="card-footer">
                  <button type="submit" value="simpan" name="simpan" class="btn btn-primary"><i class="fas fa-paper-plane"> Submit</button></i>
                </div>
              </form>
            </div>
        <!-- /.row -->
...
<?php
  if(isset($_POST['simpan'])){
    ...
    $sql = mysqli_query($koneksi, "INSERT INTO admin VALUES('','$nama','$username','$password')");
