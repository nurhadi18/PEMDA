              ...
              <form method="POST" action="">
                <div class="card-body">
                  ...
                  <div class="input-group-prepend">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="nama" placeholder="Nama Karyawan">
                  </div>
                    <div class="form-group">
                  ...
                  <div class="input-group-prepend">
                    ...
                    <input type="text " class="form-control" id="exampleInputEmail1" name="no_hp" placeholder="No.Hp"></input>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="input-group-prepend">
                    ...
                    <input type="text " class="form-control" id="exampleInputEmail1" name="jabatan" placeholder="Jabatan"></input>
                  </div>
                 </div>
                <!-- /.card-body -->

                <div class="card-footer">
                  <button type="submit" value="simpan" name="simpan" class="btn btn-success"><i class="fas fa-paper-plane"> Submit</button></i>
                </div>
              </form>
            </div>
        <!-- /.row -->
...
<?php
  if(isset($_POST['simpan'])){
    ...
    $sql = mysqli_query($koneksi, "INSERT INTO karyawan VALUES('','$nama','$jk','$alamat','$no_hp','$jabatan')");
